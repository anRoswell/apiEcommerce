...
const Controller = require('../../../controllers/api/identification-type-controller')
const routing = require('../routing')(new Controller('identification_types'))
const schema = require('../../../database/schemas/identification-type.json')
const Schema = require('../../../middlewares/schema')(schema)
const route = 'identificationtypes'
