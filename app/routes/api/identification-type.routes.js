...
const { IdentificationTypeController } = require('../../controllers/api/identification-type.controller')
const Ctrl = new IdentificationTypeController()
const schema = require('../../database/schemas/identification-type.json')
const Schema = require('../../middlewares/schema')(schema)
const JWT = require('../../middlewares/jwt')
const route = 'identification-types'
